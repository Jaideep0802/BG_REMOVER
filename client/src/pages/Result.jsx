        ...
        <div className='bg-white rounded-lg px-8 py-6 drop-shadow-sm'>
            ...
            <div className='flex flex-col sm:grid grid-cols-2 gap-8'>
                ...
                <div className='flex flex-col'>
                    ...
                    <div className='rounded-md border border-gray-300 h-full relative bg-layer ocerflow-hidden'>
                        <img className='rounded-mg border' src={assets.image_wo_bg} alt="" />
                        {/* <div className='absolute right-1/2 bottom-1/2 tranform translate-x-1/2 translate-y-1/2'>
